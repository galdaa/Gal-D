#ifndef __TESTS_H_OL97_ILRD__
#define __TESTS_H_OL97_ILRD__

/*
 * Purpose: General definitions for test files.
 * Language:  C.
 * Original Author: Arie Charfnadel.
 * Edited by:       Ronny Efronny
 * Created: 24/11/2020
 */
...
#define NTEST(name, real, expected) \
    do { \
        ++test_counter_g; \
        ((real) != (expected)) ? \
        ++success_counter_g : \
